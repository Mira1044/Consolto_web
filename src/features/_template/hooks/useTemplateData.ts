...
import type { TemplateEntity, UseTemplateReturn } from '../types';
 ...
 */
export const useTemplateData = (id: string): UseTemplateReturn => {
  const [data, setData] = useState<TemplateEntity | null>(null);
