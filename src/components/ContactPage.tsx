              ...
              <ul className="space-y-4 text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a className="text-slate-600 hover:text-blue-600" href="mailto:support@consolto.com">
                    contact@consolto.in
                    </a>
                  </div>
                </li>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
              ...
              <form onSubmit={onSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="contact-name">
                      Name
                    </label>
                    <input
                      id="contact-name"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="contact-email">
                      Email
                    </label>
                    <input
                      id="contact-email"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="contact-subject">
                    Subject
                  </label>
                  <input
                    id="contact-subject"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="contact-message">
                    Message
                  </label>
                  <textarea
                    id="contact-message"
